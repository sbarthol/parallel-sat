parallel-sat: cnf_parser.o main.o single_bit_solver.o multi_bit_solver.o rng.o concurrent_queue.o
	g++ -std=c++11 -O3 -I. -fopenmp -o parallel-sat cnf_parser.o main.o concurrent_queue.o single_bit_solver.o multi_bit_solver.o rng.o -pthread -lomp 
...
multi_bit_solver.o: multi_bit_solver.cpp multi_bit_solver.h
	g++ -std=c++11 -O3 -I. -fopenmp -c multi_bit_solver.cpp
